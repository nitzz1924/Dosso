                        ...
                        <Col lg="8" className="card p-4 rounded">
                            <Row className="justify-content-center">
                                <div className="col-lg-3 d-flex justify-content-between align-content-center my-2">
                                    <div className="fs-3 fw-bold text-center">Privacy Policy</div>
                                    <Link to="/" className="">
                            ...
                            <ul>
                                ...
                                <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Dosso21.</li>
                                ...
                                <li><strong>Website</strong> refers to Dosso21, accessible from <a href="https://dosso21.com/">https://dosso21.com/</a></li>
                            ...
                            <ul>
                                <li>By email: <a href="mailto:support@dosso21.com">support@dosso21.com</a></li>
                            </ul>
